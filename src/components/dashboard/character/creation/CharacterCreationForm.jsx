...
// src/components/dashboard/character/CreateCharacterForm.jsx
import React, { useState, useEffect } from 'react';
import {
  Dialog,
  DialogTitle,
...
const CreateCharacterForm = ({ open, onClose, onSuccess }) => {
  const [formData, setFormData] = useState({
    ...
    help_style: 'direct_suggestions',
    excited_about: [],
    frustrated_by: [],
    good_at: [],
    personality_optimistic: true,
    personality_patient: true,
    personality_serious: false,
    personality_introverted: false,
    character_flaws: [],
    unique_trait: '',
    disagreement_style: 'listen_understand',
    safety_level: 'respectful_discussion'
  });
      ...
      <form onSubmit={handleSubmit}>
        <DialogContent>
          ...
          <Grid container spacing={2}>
            ...
            {/* Language Settings */}
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>Language Settings</Typography>
            </Grid>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    ...
                    onChange={(e) => handleInputChange('is_multilingual', e.target.checked)}
                  />
                }
            ...
            {/* Character Traits */}
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>Character Traits</Typography>
            </Grid>
            ...
            {/* Communication Style */}
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>Communication Style</Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <InputLabel>Disagreement Style</InputLabel>
                <Select
                  value={formData.disagreement_style}
                  onChange={(e) => handleInputChange('disagreement_style', e.target.value)}
                  label="Disagreement Style"
                >
                  {formOptions?.disagreement_styles?.map((style) => (
            ...
            {/* Interests */}
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>Interests & Topics</Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <Autocomplete
                multiple
                options={formOptions?.excitement_topics || []}
                value={formData.excited_about}
                onChange={(e, values) => handleArrayFieldChange('excited_about', values)}
                renderTags={(value, getTagProps) =>
                  value.map((option, index) => (
                    <Chip variant="outlined" label={option} {...getTagProps({ index })} />
                  ))
            ...
            <Grid item xs={12} sm={6}>
              <Autocomplete
                multiple
                options={formOptions?.frustration_topics || []}
                value={formData.frustrated_by}
                onChange={(e, values) => handleArrayFieldChange('frustrated_by', values)}
                renderTags={(value, getTagProps) =>
                  value.map((option, index) => (
                    <Chip variant="outlined" label={option} {...getTagProps({ index })} />
                  ))
            ...
            {/* Personality Traits */}
            <Grid item xs={12}>
              <Typography variant="h6" gutterBottom sx={{ mt: 2 }}>Personality</Typography>
            </Grid>
            ...
            <Grid item xs={12}>
              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={formData.personality_optimistic}
                      onChange={(e) => handleInputChange('personality_optimistic', e.target.checked)}
                    />
                  }
                  label="Optimistic"
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={formData.personality_patient}
                      onChange={(e) => handleInputChange('personality_patient', e.target.checked)}
                    />
                  }
                  label="Patient"
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={formData.personality_serious}
                      onChange={(e) => handleInputChange('personality_serious', e.target.checked)}
                    />
                  }
                  label="Serious"
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      checked={formData.personality_introverted}
                      onChange={(e) => handleInputChange('personality_introverted', e.target.checked)}
                    />
                  }
                  label="Introverted"
        ...
        <DialogActions>
          ...
          >
            {loading ? <CircularProgress size={20} /> : 'Create Character'}
          </Button>
        </DialogActions>
      </form>
    </Dialog>
